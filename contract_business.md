...
* Revised date: December 30th 2015 
...
All work done on your proect will be billed at our hourly rate of $75.

You will be given an estimate for your project outlining the services and products to be completed. We arrive at this number based on the number of hours we expect to work on your project. We provide an estimate so all parties involved can plan accordingly for there budgets.

We reserve the right to revisit this estmate if it is deemed grosely inaccurate at anytime during the project.

### Payment schedule 

We’re sure you understand how important it is as a small business that you pay the invoices that we send you promptly. As we’re also sure you’ll want to stay friends, you agree to stick tight to the following payment schedule.

We require a non-refundable $150 start up fee to initiate work on your project. This let us know you're committed to this project and so are we.

###Invoices

We issue invoices electronically. Our payment terms are 15 days from the date of invoice. All invoices are quoted in USD. Payments can be made in cash, check, or using PayPal. 

Invoives will be sent on every other Tuesdsay.
